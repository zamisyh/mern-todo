    ...
    <div className="flex items-center justify-center w-full h-screen max-w-sm mx-auto overflow-hidden bg-white">
        <div className="px-6 py-4">
            ...
            <form>
                ...
                <div class="mt-4">
                    <button class="px-4 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded hover:bg-gray-600 focus:outline-none w-full" type="button">Sign Up</button>
                </div>
            </form>
